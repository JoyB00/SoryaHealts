                    ...
                    <div class="row">
                        <div class="col-5 my-1">
                            ...
                            <div class="card mx-auto" style="height: 200px; width: 200px;">
                                <img id="imagePreview" class="mx-auto" src="{{ auth()->user()->profile ? asset('public/images/'. $user['profile']) : 'https://cliply.co/wp-content/uploads/2020/08/442008111_GLANCING_AVATAR_3D_400.png' }}" style="height: 200px; width: 200px;">
                            </div>
                        ...
                        <div class="col-7 mt-5">
                            ...
                            <div class="row mb-3" style="font-size: 17px;">
                                ...
                                <div class="col-8">
                                    <input style="font-family: Lato light;" id="tglLahir" type="date" class="form-control" name="tglLahir" value="{{$user['tanggal_lahir']}}" required>
                                </div>
                            </div>
